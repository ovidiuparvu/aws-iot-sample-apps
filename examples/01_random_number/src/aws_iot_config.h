...
#define AWS_IOT_MQTT_CLIENT_ID         "RandomNumberGeneratingThing" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "RandomNumberGeneratingThing" ///< Thing Name of the Shadow this device is associated with
